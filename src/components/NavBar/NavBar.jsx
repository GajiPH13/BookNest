...
const Navbar = () => {
  ...
  return (
    ...
    //           </Avatar>
    //           <p>{user.name}</p>
    //           <Button variant="outline" size="sm" className={'bg-red-500 text-white'} onClick={() => authClient.signOut()}>SignOut</Button>
    //         </div>
    //       )}
    //     </div>
    //   </nav>
     ...
     <div className="border-b px-2 relative">
      ...
      >
        ...
        <div className="flex flex-col gap-4 p-4 text-sm">
          ...
          <Link href="/all-photos" onClick={() => setIsOpen(false)}>All Photos</Link>
